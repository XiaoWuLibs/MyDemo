        ...
        if (mCountDownTimer == null) {
            mCountDownTimer = new CountDownTimer(mCount, mInterval) {
                ...
                public void onTick(long millisUntilFinished) {
                    CountDownButton.this.setText(String.format(Locale.CHINA, mCountDownFormat, millisUntilFinished / 1000));
                }
                ...
                public void onFinish() {
                    ...
                    setEnabled(true);
                    CountDownButton.this.setText(TextUtils.isEmpty(mCdFinishText) ? getText().toString() : mCdFinishText);
                }
            };
        }
    }
