...
public class ThirtyFourActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        llJianTou = findViewById(R.id.llJianTou);
    ...
    protected void initData() {
        ...
        llJianTou.post(new Runnable() {
            @Override
            public void run() {
                int height = llJianTou.getHeight();
                int[] point = new int[2];
                llJianTou.getLocationOnScreen(point);
                int x = point[0];
                int y = point[1];
                Log.i("llJianTou.getHeight", y + "");
            }
        });
        ...
        viewPagerExam.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                intent.putExtra("CurrentPage", curSelPage);
    ...
    private void initReceiver() {
        ...
        intentFilter.addAction("com.example.my.ThirtyFourActivity.ThirtyFourReceiver");
        thirtyFourReceiver = new ThirtyFourReceiver();
    ...
    private void initAnimation(int height) {
        animation = new TranslateAnimation(0, 0, 1800, 1538);
    ...
    public static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            ezActivity.repeat++;
            if (ezActivity.repeat <= 5 && ezActivity.animation != null) {
                ezActivity.imageView1.setVisibility(View.VISIBLE);
                ezActivity.imageView2.setVisibility(View.VISIBLE);
                ezActivity.imageView3.setVisibility(View.VISIBLE);
                ezActivity.imageView1.startAnimation(ezActivity.animation);


                ezActivity.imageView2.startAnimation(ezActivity.animation);


                ezActivity.imageView3.startAnimation(ezActivity.animation);
            } else {
                ezActivity.animation.cancel();
                ezActivity.repeat = 0;
                ezActivity.llJianTou.setVisibility(View.GONE);
    ...
    public class ThirtyFourReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            llJianTou.setVisibility(View.VISIBLE);
            playAnimation();
        }
    }
    ...
    private void cancelAnimation() {
        if (animation != null) {
            animation.cancel();
            llJianTou.setVisibility(View.GONE);
            repeat = 0;
        }
    }
